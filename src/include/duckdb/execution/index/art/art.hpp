...
public:
	...
	bool Scan(IndexScanState &state, ARTRowIdCollection &row_ids) const;
...
private:
	...
	bool FullScan(ARTRowIdCollection &row_ids) const;
	bool SearchEqual(const ARTKey &key, ARTRowIdCollection &row_ids) const;
	bool SearchGreater(const ARTKey &key, bool equal, ARTRowIdCollection &row_ids) const;
	bool SearchLess(const ARTKey &upper_bound, bool equal, ARTRowIdCollection &row_ids) const;
